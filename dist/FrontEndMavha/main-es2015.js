...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"container custom-container\">\n    <div class=\"col-md-12\">\n      <h3 class=\"mb-3 text-center\">Create Employee</h3>\n  \n      <div class=\"form-group\">\n        <input type=\"text\" [(ngModel)]=\"Task.Description\" class=\"form-control\" placeholder=\"Name\">\n      </div>\n  \n      <div class=\"form-group\">\n        <input type=\"text\" [(ngModel)]=\"Task.State.StateName\" class=\"form-control\" placeholder=\"Name\">\n      </div>\n  \n      <div class=\"form-group\">\n        <input type=\"text\" [(ngModel)]=\"Task.DigitalInformation.FileName\" class=\"form-control\" placeholder=\"Name\">\n      </div>\n  \n      <div class=\"form-group\">\n        <button class=\"btn btn-success btn-lg btn-block\" (click)=\"addtask()\">Create Task</button>\n      </div>\n  \n    </div>\n  </div>\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<p>task-details works!</p>\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"container custom-container-2\">\n\n    <!-- Show it when there is no employee -->\n    <div class=\"no-data text-center\" *ngIf=\"task.length == 0\">\n      <p>There is no employee added yet!</p>\n      <button class=\"btn btn-outline-primary\" routerLink=\"/create-task\">Add Empoyee</button>\n    </div>\n  \n    <!-- Employees list table, it hides when there is no task -->\n    <div *ngIf=\"task.length !== 0\">\n      <h3 class=\"mb-3 text-center\">Employees List</h3>\n  \n      <div class=\"col-md-12\">\n        <table class=\"table table-bordered\">\n          <thead>\n            <tr>\n              <th scope=\"col\">Id</th>\n              <th scope=\"col\">Name</th>\n              <th scope=\"col\">State</th>\n              <th scope=\"col\">File</th>\n              <th scope=\"col\">Action</th>\n            </tr>\n          </thead>\n          <tbody>\n            <tr *ngFor=\"let t of task\">\n              <td>{{t.id}}</td>\n              <td>{{t.Description}}</td>\n              <td>{{t.State.StateName}}</td>\n              <td>{{t.DigitalInformation}}</td>\n              <td>\n                <span class=\"edit\" routerLink=\"/task-edit/{{t.id}}\">Edit</span>\n                <span class=\"delete\" (click)=\"deleteTask(t.id)\">Delete</span>\n              </td>\n            </tr>\n          </tbody>\n        </table>\n      </div>\n  \n    </div>\n  \n  </div>\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"container custom-container\">\n    <div class=\"col-md-12\">\n      \n      <h3 class=\"mb-3 text-center\">Update Task</h3>\n  \n      <div class=\"form-group\">\n        <input type=\"text\" [(ngModel)]=\"task.Description\" class=\"form-control\" placeholder=\"Name\">\n      </div>\n  \n      <!-- <div class=\"form-group\">\n        <input type=\"text\" [(ngModel)]=\"task.email\" class=\"form-control\" placeholder=\"Email\">\n      </div>\n  \n      <div class=\"form-group\">\n        <input type=\"text\" [(ngModel)]=\"employeeData.phone\" class=\"form-control\" placeholder=\"Phone\">\n      </div> -->\n  \n      <div class=\"form-group\">\n        <button class=\"btn btn-success btn-lg btn-block\" (click)=\"updateTask()\">Update Task</button>\n      </div>\n      \n    </div>\n  </div>\n");
...
/* harmony import */ var _task_create_task_create_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./task-create/task-create.component */ "./src/app/task-create/task-create.component.ts");
...
/* harmony import */ var _task_update_task_update_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./task-update/task-update.component */ "./src/app/task-update/task-update.component.ts");
...
const routes = [
    ...
    { path: 'create-task', component: _task_create_task_create_component__WEBPACK_IMPORTED_MODULE_3__["TaskCreateComponent"] },
    { path: 'task-details/:id', component: _task_details_task_details_component__WEBPACK_IMPORTED_MODULE_4__["TaskDetailsComponent"] },
    { path: 'update-task', component: _task_update_task_update_component__WEBPACK_IMPORTED_MODULE_5__["TaskUpdateComponent"] },
    { path: 'task-list', component: _task_list_task_list_component__WEBPACK_IMPORTED_MODULE_6__["TaskListComponent"] }
];
...
/* harmony import */ var _task_create_task_create_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./task-create/task-create.component */ "./src/app/task-create/task-create.component.ts");
/* harmony import */ var _task_details_task_details_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./task-details/task-details.component */ "./src/app/task-details/task-details.component.ts");
/* harmony import */ var _task_update_task_update_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./task-update/task-update.component */ "./src/app/task-update/task-update.component.ts");
...
let RestApiService = class RestApiService {
    ...
    createEmployee(task) {
        return this.http.post(this.apiURL + '/Task', JSON.stringify(task), this.httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    }
    // HttpClient API put() method => Update employee
    updateEmployee(id, task) {
        return this.http.put(this.apiURL + '/Task/' + id, JSON.stringify(task), this.httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    }
    // HttpClient API delete() method => Delete employee
    deleteTask(id) {
        return this.http.delete(this.apiURL + '/Task/' + id, this.httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    }
    // Error handling 
    handleError(error) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3Rhc2stZGV0YWlscy90YXNrLWRldGFpbHMuY29tcG9uZW50LmNzcyJ9 */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3Rhc2stdXBkYXRlL3Rhc2stdXBkYXRlLmNvbXBvbmVudC5jc3MifQ== */");
...
let TaskUpdateComponent = class TaskUpdateComponent {
    ...
    updateTask() {
        if (window.confirm('Are you sure, you want to update?')) {
            this.restApi.updateEmployee(this.id, this.taskData).subscribe(data => {
...
TaskUpdateComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-task-update',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./task-update.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/task-update/task-update.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./task-update.component.css */ "./src/app/task-update/task-update.component.css")).default]
    })
], TaskUpdateComponent);
...
module.exports = __webpack_require__(/*! C:\FrontEnd-Mahva\FrontEndMavha\src\main.ts */"./src/main.ts");
